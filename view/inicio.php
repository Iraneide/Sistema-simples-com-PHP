	...
	<section class="full-box cover dashboard-sideBar">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
				SISTEMA WEB <i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
			</div>
			<!-- SideBar User info -->
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					<a href="#!" class="btn-sideBar-SubMenu">
						<i class="zmdi zmdi-case zmdi-hc-fw"></i> Gestão de Produtos <i class="zmdi zmdi-caret-down pull-right"></i>
					</a>
					<ul class="list-unstyled full-box">
						<li>
							<a href="categorias.php"><i class="zmdi zmdi-timer zmdi-hc-fw"></i> Categoria</a>
						</li>
						<li>
							<a href="subject.html"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Produtos</a>
						</li>
						<li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><small>Sistema Web Crud PHP</small></h1>
			</div>
		</div>
